 ...
 */ !(function () {
        ...
        volume: function (e) {
            ...
            if (((e = parseFloat(e)), e >= 0 && 1 >= e)) {
                ...
                for (var r in t._howls)
                    if (
                        t._howls.hasOwnProperty(r) &&
                        t._howls[r]._webAudio === !1
                    )
                        for (var i = 0; i < t._howls[r]._audioNode.length; i++)
                            t._howls[r]._audioNode[i].volume =
                                t._howls[r]._volume * t._volume;
                return t;
            }
        ...
        _setMuted: function (e) {
            ...
            for (var r in t._howls)
                if (t._howls.hasOwnProperty(r) && t._howls[r]._webAudio === !1)
                    for (var i = 0; i < t._howls[r]._audioNode.length; i++)
                        t._howls[r]._audioNode[i].muted = e;
        },
        codecs: function (e) {
            ...
            if (
                ...
                var n = function () {
                    ...
                    (i.buffer = r),
                        ...
                        setTimeout(function () {
                            (i.playbackState === i.PLAYING_STATE ||
                                i.playbackState === i.FINISHED_STATE) &&
                                ((e._iOSEnabled = !0),
                                (e.iOSAutoEnable = !1),
    ...
    var f = new o(a),
        l = function (e) {
            ...
            (r._autoplay = e.autoplay || !1),
                ...
                void 0 !== t && t && f.iOSAutoEnable && f._enableiOSAudio(),
                f._howls.push(r),
                r.load();
        };
    if (
        ((l.prototype = {
            load: function () {
                ...
                if (((e._src = t), e._webAudio)) c(e, t);
                    ...
                    u.addEventListener(
                        "error",
                        function () {
                            u.error && 4 === u.error.code && (o.noAudio = !0),
                                e.on("loaderror", {
                    ...
                    var l = function () {
                        (e._duration = Math.ceil(10 * u.duration) / 10),
                            0 ===
                                Object.getOwnPropertyNames(e._sprite).length &&
                                (e._sprite = {
                                    _default: [0, 1e3 * e._duration],
                                }),
                            e._loaded || ((e._loaded = !0), e.on("load")),
                            e._autoplay && e.play(),
                            u.removeEventListener("canplaythrough", l, !1);
                    };
                        ...
                        ? r._sprite[e]
                            ? (r._inactiveNode(function (i) {
                                  ...
                                  var s =
                                      ...
                                      o = 0;
                                  r._webAudio
                                      ? ((o = r._sprite[e][1] / 1e3 - i._pos),
                                        i._pos > 0 &&
                                            (s = r._sprite[e][0] / 1e3 + s))
                                      : (o =
                                            r._sprite[e][1] / 1e3 -
                                            (s - r._sprite[e][0] / 1e3));
                                  var u,
                                      a = !(!r._loop && !r._sprite[e][2]),
                                      l =
                                          "string" == typeof n
                                              ? n
                                              : Math.round(
                                  ...
                                  if (
                                      ...
                                      (i.id = l),
                                          ...
                                          void 0 === i.bufferSource.start
                                              ? i.bufferSource.noteGrainOn(
                                                    0,
                                                    s,
                                                    o
                                                )
                                              : i.bufferSource.start(0, s, o);
                                  } else {
                                      if (
                                          4 !== i.readyState &&
                                          (i.readyState ||
            ...
            stop: function (e) {
                ...
                if (n)
                    if (((n._pos = 0), t._webAudio)) {
                        ...
                        isNaN(n.duration) || (n.pause(), (n.currentTime = 0));
                return t;
            },
            mute: function (e) {
                var t = this;
                ...
                var n = e ? t._nodeById(e) : t._activeNode();
                return (
                    n && (t._webAudio ? (n.gain.value = 0) : (n.muted = !0)), t
                );
            },
            unmute: function (e) {
                var t = this;
            ...
            pos: function (e, n) {
                ...
                if (i)
                    return e >= 0
                        ? (r.pause(n), (i._pos = e), r.play(i._sprite, n), r)
                        : r._webAudio
                        ? i._pos + (t.currentTime - r._playStart)
                        : i.currentTime;
                if (e >= 0) return r;
                for (var s = 0; s < r._audioNode.length; s++)
                    if (
                        r._audioNode[s].paused &&
                        4 === r._audioNode[s].readyState
                    )
                        return r._webAudio
                            ? r._audioNode[s]._pos
                            : r._audioNode[s].currentTime;
            },
            pos3d: function (e, t, n, r) {
                ...
                if (i._webAudio) {
                    ...
                    s &&
                        ((i._pos3d = [e, t, n]),
                        s.panner.setPosition(e, t, n),
                        (s.panner.panningModel = i._model || "HRTF"));
                }
                return i;
            },
            fade: function (e, t, n, r, i) {
                ...
                for (var l = 1; a >= l; l++)
                    !(function () {
                        var e = s._volume + ("up" === u ? 0.01 : -0.01) * l,
            ...
            _nodeById: function (e) {
                for (
                    var t = this, n = t._audioNode[0], r = 0;
            ...
            _inactiveNode: function (e) {
                for (
                    var t = this, n = null, r = 0;
                    r < t._audioNode.length;
                    r++
                )
                    if (
                        t._audioNode[r].paused &&
                        4 === t._audioNode[r].readyState
                    ) {
            ...
            _drainPool: function () {
                var e,
                    t = this,
                    n = 0;
                for (e = 0; e < t._audioNode.length; e++)
                    t._audioNode[e].paused && n++;
                for (e = t._audioNode.length - 1; e >= 0 && !(5 >= n); e--)
                    t._audioNode[e].paused &&
                        (t._webAudio && t._audioNode[e].disconnect(0),
                        n--,
                        t._audioNode.splice(e, 1));
            },
            ...
            unload: function () {
                for (
                    var t = this, n = t._audioNode, r = 0;
                    r < t._audioNode.length;
                    r++
                )
                    n[r].paused || (t.stop(n[r].id), t.on("end", n[r].id)),
                        t._webAudio ? n[r].disconnect(0) : (n[r].src = "");
                for (r = 0; r < t._onendTimer.length; r++)
                    clearTimeout(t._onendTimer[r].timer);
        ...
        var c = function (t, n) {
            ...
            d = function (n, r, i) {
                ...
                (s.bufferSource = t.createBufferSource()),
                    ...
                    r[0] &&
                        ((s.bufferSource.loopStart = r[1]),
                        (s.bufferSource.loopEnd = r[1] + r[2])),
    ...
    "function" == typeof define &&
        ...
        "undefined" != typeof exports &&
            ((exports.Howler = f), (exports.Howl = l)),
        "undefined" != typeof window &&
            ((window.Howler = f), (window.Howl = l));
})();
